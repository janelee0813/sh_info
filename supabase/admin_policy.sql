...
--
-- 관리자 비밀번호(admin.html 로그인과 동일): 7890
...
-- 나중에 비밀번호를 바꾸고 싶다면, 위 함수 전체와 migration_2026_apply_form.sql의
-- delete_application 함수를 둘 다 새 비밀번호로 바꿔서 재실행하세요. (두 곳이 항상 같아야 합니다)
